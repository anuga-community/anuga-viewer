...
public:
    ...
    virtual float getStageHeightMax() {return _state.stageheightmax;}
    virtual void setStageHeightMax(float v) {_state.stageheightmax = v;}
...
protected:
    ...
    struct
    {
          ...
          float stageheightmax;  // stage colour span (m); auto-set to terrain z-range
